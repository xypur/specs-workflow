...
Create the `.specs/<module>/` for the feature described in `$1`, with all four documents at once. If `$1` is empty, ask the user to describe the feature first.
